...
public class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student(22123456L,"Yassine","BILAL","HH111111","yassine@gmail.com",
                "11,bloc 1 Hay Anass", CountryType.MA,152415L, AssuranceType.SAHAM,1000);

        Student student2 = new Student(20997812L,"kamal","bhf","HH333333","bhfkamal@gmail.com",
